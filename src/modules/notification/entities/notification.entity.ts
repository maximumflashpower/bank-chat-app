...
export class Notification extends BaseEntity {
  ...
  @Column({ name: 'channel', type: 'enum', enum: NotificationChannel, default: NotificationChannel.IN_APP })
  ...
  @ApiProperty({ example: '{"accountId":"...","amount":5000}', description: 'Structured metadata', required: false })
  @Column({ name: 'metadata', type: 'jsonb', nullable: true })
  metadata: Record<string, any> | null;

  @ApiProperty({ example: null, description: 'When the notification was read', required: false })
